...
int main() {
	char date[1024] = "";
	char winningTeam[1024] = "";
	char losingTeam[1024] = "";
	int  winningPoint = 0;
	int  losingPoint = 0;
	char startingPitcherOfLosingTeam[1024] = "";
	char startingPitcherOfWinningTeam[1024] = "";
	char bestPlayer[1024] = "";
	char bestPlayPoint[1024] = "";
	int  scoreAtBestPlayPoint = 0;
	char missedPlayer[1024] = "";
	char filename[1024] = "";
	char line[1024] = "";
	FILE *inFile = NULL;
